...
const char* ssid = "SLT-4G-CC53";             //Add your WiFi ssid
const char* password =  "0R416Y55LR4";    //Add your WiFi password

String apiKey = "460432";              //Add your Token number that bot has sent you on WhatsApp messenger
String phone_number = "+94717856414"; //Add your WhatsApp app registered phone number (same number that bot send you in url)
